...
\mysubsection{1}{L'ensembles des entiers naturels $\N$}
...
\begin{exemple}
    \begin{enumerate}
        ...
        \item Le nombre $x = 0,1234567891011121314151617\dots$ est un nombre irrationnel, car les nombres aprés la virgule n'est pas périodique. ($x\not\in\Q)$
...
\mysubsection{1}{Règle fondamentales de dévellopement et de factorisation}
\begin{Proposition}
